...
export default function Home() {
    ...
    return (
        <main className="container mx-auto py-[20px] sm:py-[50px] bg-dark-bg ">
            <header className="grid grid-cols-2 grid-rows-2 gap-1 lg:px-10">
            ...
            {/* hero section */}
            <section className="flex flex-col lg:gap-20 justify-between mt-10 sm:px-[32px] md:flex-row md:px[48] lg:px-20">
                <div className="px-[20px] pt-16 flex flex-1 flex-col items-center lg:pt-22 ">
                    <h1 className="flex justify-center text-4xl text-slate-200 leading-10 lg:pt-20">
                        Hi, I am Łukasz Szmyd
                        <br />
                        Front-end Developer
                    </h1>
            ...
            <section className=" bg-[url(/slice7.png)] bg-cover w-full h-auto  sm:px-[35px] lg-h-[600px] lg:grid lg:grid-rows-[100px_300px_auto] lg:grid-cols-2 font-['Inter'] pt-8 ">
                <h3 className="py-4 text-3xl text-center lg:h-[100px] lg:col-span-2 lg: lg:text-[30px] text-lime-800">
                    About me
                </h3>
                <Image
                ...
                <div className="sd:w-[510px] sd:h-[240px] mx-auto mb-unit-3">
                    <p className="text-base lg:text-[36px] text-center px-4">
                ...
                <div className=" flex flex-wrap px-[35px] py-4 lg:col-span-2">
                    {skils.map((skil) => (
                        <span key={skil.id} className={` ${skilsStyle.skils}`}>
                            {skil.name}
                        </span>
                    ))}

                    <span className={`text-[28px] ${skilsStyle.skils}`}>
                        Html
                    </span>
                    <span className={`${skilsStyle.skils}`}>Scss</span>
                    <span className={`text-[24px] ${skilsStyle.skils}`}>
                        JavaScript
                    </span>
                    <span className={`text-[24px] ${skilsStyle.skils}`}>
                        TypeScript
            ...
            <section className="px-[75px] pt-8 ">
                ...
                <div className="flex flex-col items-center justify-center sm:justify-between py-[30px]">
                    ...
                    <div className="w-[100vw] sm:w-[480px] h-auto mx-auto  bg-light-bg">
                        <h4 className="mt-3 ml-4 text-orange-action">
                            Shopping App
                        </h4>
