      ...
      <main className='  container mx-auto max-w-[1240px] py-[20px] sm:py-[30px] bg-gray-50  text-black dark:bg-dark-bg dark:text-slate-200'>
        <header className='grid grid-rows-2 items-center gap-1 lg:px-10'>
          <h1 className=' text-4xl ml-[35px] col-span-1 self-center bg-orange-action bg-clip-text text-transparent'>
            Web & <span className='text-black dark:text-slate-100'>Wolf</span>
          </h1>
          ...
          {!isChecked && (
            <div className='col-start-2 self-center justify-self-end mr-[35px] '>
              <Swap theme={theme} handleThemeChange={handleThemeChange} />
            </div>
          )}
          {isChecked && (
        ...
        >
          ...
          <div className='sd:w-[510px] sd:h-[240px] mx-auto mb-unit-3 lg:pt-10'>
            <p className="text-[20px] lg:text-[28px] text-center px-4 font-['Cal-Sans']">
              Front-end developer with over two years of commercial experience.
              My main stack is React along with TypeScript and Next js. I enjoy
              exploring the React ecosystem and learning new technologies. In
              the future I would like to get better at back-and and become a
              fullstack developer.
            </p>
          </div>
